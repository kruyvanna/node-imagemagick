...
exports.identify = function(pathOrArgs, callback) {
  ...
  var proc = exec2(exports.identify.path, args, { timeout: 120000 }, function(
    err,
    stdout,
    stderr
  ) {
...
exports.readMetadata = function(path, callback) {
  return exports.identify(['-format', '%[EXIF:*]', path], function(
    err,
    stdout
  ) {
    var meta = {}
    ...
    t.args.forEach(function(arg) {
      ...
      if (arg != '-resize' && ignoreArg) {
        ...
        args = args.concat([
          ...
          dGravity,
          '-crop',
          '' + t.opt.width + 'x' + t.opt.height + '+0+0',
          '-auto-orient',
          '+repage'
        ])
        ignoreArg = false
